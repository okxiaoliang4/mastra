...
<PropertiesTable
  ...
  },
  {
    ...
    type: '() => void',
    description:
      'Releases buffered chunks and event listeners after you finish consuming fullStream and no longer need replay.',
  },
]}
/>
...
Process `fullStream` events and call `dispose()` after the loop if you do not need replay.
